...
@section('content')
<div class="container">
<form role="form" method="POST" action="{{ route('products.update',$products->id) }}" style="margin-top: 100px;" enctype="multipart/form-data">
{{ csrf_field() }}
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Product Item Id</label>
                  <input type="text" class="form-control" id="item_id" name="item_id" placeholder="Enter Products Name" value="{{$products->item_id}}">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Product Name</label>
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Enter Products Name" value="{{$products->product_name}}">
                </div>
                <div class="form-group">
                  <div class='row'>
                    <div class='col-md-3'>
                    ...
                    <div class='col-md-3'>
                      <select class="form-control" id="category_id" name="category_id" value="{{$products->categories_Name}}">
                      
                        <option value="{{$products->categories_id}}">{{$products->categories_Name}}</option>
                ...
                <div class="form-group">
                  <div class='row'>
                    ...
                    <div class='col-md-3'>
                      <select class="form-control" id="isActive" name="isActive" value="{{$products->isActive}}">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" id="proDiscr" name="product_description" placeholder="Enter ...">{{$products->product_description}}</textarea>
                </div>
