...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Layout Index</b></span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('categories')}}"><i class="fa fa-circle-o"></i> View Categories</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('addProducts')}}"><i class="fa fa-circle-o"></i> Add Products</a></li>
            <li><a href="{{route('addCategories')}}"><i class="fa fa-circle-o"></i> Edit Products</a></li>
          </ul>
        </li>
      </ul>
    </section>
